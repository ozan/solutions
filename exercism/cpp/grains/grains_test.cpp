...
BOOST_AUTO_TEST_CASE(square_1) { BOOST_REQUIRE_EQUAL(1ULL, grains::square(1)); }

BOOST_AUTO_TEST_CASE(square_2) { BOOST_REQUIRE_EQUAL(2ULL, grains::square(2)); }

BOOST_AUTO_TEST_CASE(square_3) { BOOST_REQUIRE_EQUAL(4ULL, grains::square(3)); }

BOOST_AUTO_TEST_CASE(square_4) { BOOST_REQUIRE_EQUAL(8ULL, grains::square(4)); }

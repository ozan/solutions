...
BOOST_AUTO_TEST_CASE(string_representation) {
  ...
  const std::string expected{"_ _ _ _ _ _ _ _\n"
                             "_ _ _ _ _ _ _ _\n"
                             "_ _ _ _ W _ _ _\n"
                             "_ _ _ _ _ _ _ _\n"
                             "_ _ _ _ _ _ _ _\n"
...
BOOST_AUTO_TEST_CASE(queens_cannot_attack) {
  const queen_attack::chess_board board{std::make_pair(2, 3),
                                        std::make_pair(4, 7)};
...
BOOST_AUTO_TEST_CASE(queens_can_attack_when_they_are_on_the_same_column) {
  const queen_attack::chess_board board{std::make_pair(5, 4),
                                        std::make_pair(2, 4)};
...
BOOST_AUTO_TEST_CASE(queens_can_attack_diagonally) {
  const queen_attack::chess_board board{std::make_pair(1, 1),
                                        std::make_pair(6, 6)};
...
BOOST_AUTO_TEST_CASE(queens_can_attack_another_diagonally) {
  const queen_attack::chess_board board{std::make_pair(0, 6),
                                        std::make_pair(1, 7)};
...
BOOST_AUTO_TEST_CASE(queens_can_attack_on_the_nw_so_diagonal) {
  const queen_attack::chess_board board{std::make_pair(1, 6),
                                        std::make_pair(6, 1)};
...
BOOST_AUTO_TEST_CASE(
    queens_cannot_attack_if_not_on_same_row_column_or_diagonal) {
  const queen_attack::chess_board board{std::make_pair(1, 1),
                                        std::make_pair(3, 7)};

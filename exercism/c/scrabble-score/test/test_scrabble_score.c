...
void test_lowercase_letter(void) { TEST_ASSERT_EQUAL(1, score("a")); }

void test_uppercase_letter(void) { TEST_ASSERT_EQUAL(1, score("A")); }

void test_valuable_letter(void) { TEST_ASSERT_EQUAL(4, score("f")); }

void test_short_word(void) { TEST_ASSERT_EQUAL(2, score("at")); }

void test_short_valuable_word(void) { TEST_ASSERT_EQUAL(12, score("zoo")); }

void test_medium_word(void) { TEST_ASSERT_EQUAL(6, score("street")); }

void test_medium_valuable_word(void) { TEST_ASSERT_EQUAL(22, score("quirky")); }

void test_long_mixed_case_word(void) {
  TEST_ASSERT_EQUAL(41, score("OxyphenButazone"));
}

void test_english_like_word(void) { TEST_ASSERT_EQUAL(8, score("pinata")); }

void test_empty_input(void) { TEST_ASSERT_EQUAL(0, score("")); }

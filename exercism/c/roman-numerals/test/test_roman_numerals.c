...
void test_one_yields_I(void) { test_conversion(1, "I"); }

void test_two_yields_II(void) { test_conversion(2, "II"); }

void test_three_yields_III(void) { test_conversion(3, "III"); }

void test_four_yields_IV(void) { test_conversion(4, "IV"); }

void test_five_yields_V(void) { test_conversion(5, "V"); }

void test_six_yields_VI(void) { test_conversion(6, "VI"); }

void test_nine_yields_IX(void) { test_conversion(9, "IX"); }

void test_twenty_seven_yields_XXVII(void) { test_conversion(27, "XXVII"); }

void test_forty_eight_yields_XLVIII(void) { test_conversion(48, "XLVIII"); }

void test_fifty_nine_yields_LIX(void) { test_conversion(59, "LIX"); }

void test_ninety_three_yields_XCIII(void) { test_conversion(93, "XCIII"); }
...
void test_four_hundred_two_yields_CDII(void) { test_conversion(402, "CDII"); }
...
void test_three_thousand_yields_MMM(void) { test_conversion(3000, "MMM"); }

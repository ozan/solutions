...
void test_encode_yes(void) { test_encode("yes", "bvh"); }

void test_encode_no(void) { test_encode("no", "ml"); }

void test_encode_OMG(void) { test_encode("OMG", "lnt"); }

void test_encode_spaces(void) { test_encode("O M G", "lnt"); }
...
void test_decode_exercism(void) { test_decode("vcvix rhn", "exercism"); }

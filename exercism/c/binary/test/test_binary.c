...
void test_b0_is_decimal_0(void) { TEST_ASSERT_EQUAL(0, convert("0")); }

void test_b1_is_decimal_1(void) { TEST_ASSERT_EQUAL(1, convert("1")); }

void test_b10_is_decimal_2(void) { TEST_ASSERT_EQUAL(2, convert("10")); }

void test_b11_is_decimal_3(void) { TEST_ASSERT_EQUAL(3, convert("11")); }

void test_b100_is_decimal_4(void) { TEST_ASSERT_EQUAL(4, convert("100")); }

void test_b1001_is_decimal_9(void) { TEST_ASSERT_EQUAL(9, convert("1001")); }
